...
template<class T>
void unique(T& t) { (t).erase(unique((t).begin(), (t).end()), (t).end()); }
template<class T, class S>
bool chmax(T& t, const S& s) { if(s > t) { t = s; return true; } return false; }
template<class T, class S>
bool chmin(T& t, const S& s) { if(s < t) { t = s; return true; } return false; }
void BR() { std::cout << "\n"; }
