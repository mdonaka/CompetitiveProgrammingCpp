...
auto MMM(const __m512i& a, const __m512i& b) {
    ...
    static const __m512i MOD_512 = _mm512_set_epi64(MOD, MOD, MOD, MOD, MOD, MOD, MOD, MOD);
    static const __m512i MOD_r_512 = _mm512_set_epi64(MOD_r, MOD_r, MOD_r, MOD_r, MOD_r, MOD_r, MOD_r, MOD_r);
    static const __m512i MODm1_512 = _mm512_set_epi64(MODm1, MODm1, MODm1, MODm1, MODm1, MODm1, MODm1, MODm1);
    static const __m512i r2_512 = _mm512_set_epi64(r2, r2, r2, r2, r2, r2, r2, r2);
    static const __m512i mask_512 = _mm512_set_epi64(mask, mask, mask, mask, mask, mask, mask, mask);
