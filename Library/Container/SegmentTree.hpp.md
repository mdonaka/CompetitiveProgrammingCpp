...
data:
  ...
  bundledCode: "#line 2 \"Library/Container/SegmentTree.hpp\"\n\r\n#include <vector>\r\
    ...
    \    int calcSize(int n) const { int size = 1; while(size < n) { size <<= 1; }return\
  ...
  requiredBy: []
  timestamp: '2022-07-26 00:27:13+09:00'
